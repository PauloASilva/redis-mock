...
RedisClient.prototype.zcard = RedisClient.prototype.ZCARD = function (key, callback) {
  sortedSetFunctions.zcard.call(this, MockInstance, key, callback);
}

RedisClient.prototype.zadd = RedisClient.prototype.ZADD = function (args, callback) {
  sortedSetFunctions.zadd.call(this, MockInstance, args, callback);
}

RedisClient.prototype.zrem = RedisClient.prototype.ZREM = function (key, member, callback) {
  sortedSetFunctions.zrem.call(this, MockInstance, key, member, callback);
}
 ...
 * Transactions
 */
var transactionFunctions = require('./transaction.js');
RedisClient.prototype.multi = RedisClient.prototype.MULTI = function (args) {
  return transactionFunctions.multi.call(this, this, args);
}

RedisClient.prototype.exec = RedisClient.prototype.EXEC = function (args, callback) {
  return transactionFunctions.multi.call(this, args, callback);
}
